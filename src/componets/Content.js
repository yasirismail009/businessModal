...
import * as animationData from "../assets/xDGDGHkOve.json";
import * as animationDataNew from "../assets/DVSyMrUi4R.json";
import * as animationDataNewBlack from "../assets/DVSyMrUi4RNeqw.json";
        ...
        <div className="w-full h-64 flex flex-col justify-between dark:bg-gray-800 bg-white dark:border-gray-700 rounded-lg border border-gray-400 mb-6 py-5 px-4">
          ...
          <div>
            <div className="flex items-center justify-between text-gray-800 dark:text-gray-100">
              ...
              <div onClick={handleOpen} className="w-8 h-8 rounded-full bg-gray-800 dark:bg-gray-100 dark:text-gray-800 text-white flex items-center justify-center">
                <Lottie
                  options={{
                    loop: true,
                    autoplay: true,
                    animationData: animationDataNewBlack,
                    rendererSettings: {
        ...
        <div className="w-full h-64 flex flex-col justify-between bg-pink-300 rounded-lg border border-pink-300 mb-6 py-5 px-4">
          ...
          <div>
            <div className="flex items-center justify-between text-gray-800">
              <p className="text-sm">March 28, 2020</p>
              <div onClick={handleOpen}  className="w-8 h-8 rounded-full bg-gray-800 text-white flex items-center justify-center">
                <Lottie
                  options={{
                    loop: true,
                    autoplay: true,
        ...
        <div className="w-full h-64 flex flex-col justify-between dark:bg-gray-800 bg-white dark:border-gray-700 rounded-lg border border-gray-400 mb-6 py-5 px-4">
          ...
          <div>
            ...
            <div className="flex items-center justify-between text-gray-800">
              ...
              <div onClick={handleOpen}  className="w-8 h-8 rounded-full dark:bg-gray-100 dark:text-gray-800 bg-gray-800 text-white flex items-center justify-center">
                <Lottie
                  options={{
                    loop: true,
                    autoplay: true,
      ...
      <div className="rounded">
        <div className="w-full h-64 flex flex-col justify-between items-start dark:bg-gray-800 bg-white dark:border-gray-700 rounded-lg border border-gray-400 mb-6 py-5 px-4">
          ...
          <div className="w-full flex flex-col items-start">
            ...
            <div className="flex items-center justify-between text-gray-800 dark:text-gray-100 w-full">
              <p className="text-sm">March 28, 2020</p>
              <div onClick={handleOpen}  className="w-8 h-8 rounded-full bg-gray-800 dark:text-gray-800 dark:bg-gray-100 text-white flex items-center justify-center">
                <Lottie
                  options={{
                    loop: true,
                    autoplay: true,
        ...
        <div className="w-full h-64 flex flex-col justify-between bg-gray-300 dark:bg-gray-700 dark:border-gray-700 rounded-lg border border-gray-300 mb-6 py-5 px-4">
          ...
          <div>
            <div className="flex items-center justify-between text-gray-800 dark:text-gray-100">
              <p className="text-sm">March 28, 2020</p>
              <div onClick={handleOpen}  className="w-8 h-8 rounded-full bg-gray-800 text-white dark:bg-gray-100 dark:text-gray-800 flex items-center justify-center">
                <Lottie
                  options={{
                    loop: true,
                    autoplay: true,
